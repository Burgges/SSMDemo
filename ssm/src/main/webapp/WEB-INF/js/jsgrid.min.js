...
!function (a, b, c) {
    ...
    d.prototype = {
        ...
        _refreshContent: function () {
            // $("#userList").find("tr.jsgrid-insert-row").css("display", "none");
            var a = this._content;
        ...
        _refreshWidth: function () {
            var a = this._headerGrid, b = this._bodyGrid, c = this.width;
        ...
        loadData: function (a) {
            ...
            $("#userList").find("tr.jsgrid-insert-row").css("display", "none");
            $("#userList").find("tr.jsgrid-insert-row").find("input[type=text]").val("");
            // $("td.jsgrid-cell").attr("style","word-wrap: break-word; white-space: pre-wrap; white-space: -pre-wrap; white-space: -o-pre-wrap;  white-space: normal !important; height: auto; vertical-align: text-top; padding-top: 2px; padding-bottom: 3px;");
        ...
        _validateItem: function (a, d) {
            var e = [], f = {item: a, itemIndex: this._rowIndex(d), row: d};
            if (this._eachField(function (g) {
                    if (g.validate) {
                        var h = this._getItemFieldValue(a, g);
                        if (h !== c) {
                            var i = this._validation.validate(b.extend({value: h, rules: g.validate}, f));
                            this._setCellValidity(d.children().eq(this._visibleFieldIndex(g)), i), i.length && e.push.apply(e, b.map(i, function (a) {
            ...
            return this._callEventHandler(this.onItemInvalid, g), this.invalidNotify(g), !1
        },
        ...
        _createEditRow: function (a) {
            if (b.isFunction(this.editRowRenderer))return b(this.renderTemplate(field.editRowRenderer, field, {
                item: a,
        ...
        _updateRow: function (a, c) {
            var d = a.data(g), e = this._itemIndex(d), f = b.extend(!0, {}, d);
            b.extend(!0, d, c);
            var h = this._callEventHandler(this.onItemUpdating, {row: a, item: d, itemIndex: e, previousItem: f});
            return this._controllerCall("updateItem", d, h.cancel, function (b) {
                b = b || d;
                var c = this._finishUpdate(a, b, e);
                this._callEventHandler(this.onItemUpdated, {row: c, item: b, itemIndex: e, previousItem: f})
            })
        },
    ...
    a.jsGrid = {Grid: d, fields: w, setDefaults: x, locales: y, locale: z, version: "1.5.2"}
